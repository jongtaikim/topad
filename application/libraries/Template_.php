...
class Template_
{
	...
	var $compile_dir   = './template/_compile';
	var $compile_ext   = 'php';
	var $skin          = '';
	var $notice        = false;
	...
	function define($arg, $path='')
	{
		...
		else foreach ((array)$arg as $fid => $path) $this->_define($fid, $path);
	}
...
echo "=======================================12 ${sub}";
				...
				//echo "<br>include tpl : $cpl_path / $tid / $scope  / <br>";
