...
$lang['db_invalid_connection_str'] = '제출된 연결 문자열에 기반한 데이터베이스 설정을 확정할 수 없습니다.';
$lang['db_unable_to_connect'] = '제공된 설정으로는 데이터베이스 서버에 접속할수 없습니다.';
$lang['db_unable_to_select'] = '명시된 다음의 데이터베이스를 선택할 수 없습니다: %s';
$lang['db_unable_to_create'] = '명시된 다음의 데이터베이스를 생성할 수 없습니다: %s';
...
$lang['db_transaction_failure'] = '트랙잭션 실패 : 롤백이 실행되었습니다.';
...
$lang['db_unable_to_set_charset'] = '다음의 클라이언트 접속 문자셋을 설정할 수 없습니다: %s';
